...
```cmake
add_qt_android_apk(my_app_apk my_app
    ANDROID_MANIFEST_IN_PATH Path/To/My/Manifest/AndroidManifest.xml.in
)
```
...
If you want to see all of the output of `qtandroiddeploy`. This can be really useful when debugging.
